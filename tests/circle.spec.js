...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Teste se circle retorna undefined, caso o parâmetro passado não seja um número', () => {
    expect(circle('um')).toBeUndefined();
  })
  ...
  it('Teste se o objeto retornado possui 3 propriedades', () => {
    expect(Object.keys(circle(7))).toHaveLength(3);
  })
  ...
  it('este se dentro do objeto retornado, a função retorna uma `key` com `value` igual à circunferência correta para um círculo de raio 2', () => {
